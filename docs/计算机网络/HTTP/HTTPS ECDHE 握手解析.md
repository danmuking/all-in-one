...
![](https://raw.githubusercontent.com/danmuking/image/main/39361489f05a8c63bf117a7527e9ed38.png)
那么对于底数为 2 的时候， 32 的对数是 5，64 的对数是 6，计算过程如下：
![](https://raw.githubusercontent.com/danmuking/image/main/9fcc538e5345727343013dfe9f1c50ff.png)
对数运算的取值是可以连续的，而离散对数的取值是不能连续的，因此也以「离散」得名，
离散对数是在对数运算的基础上加了「模运算」，也就说取余数，对应编程语言的操作符是「%」，也可以用 mod 表示。离散对数的概念如下图：
![](https://raw.githubusercontent.com/danmuking/image/main/f62235a7a6eda1909bd102e225846957.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/74abe724c6498ce0445bd65b17bb3bf6.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/909853a3b0ee6e5732a1e1a980964a7c.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/cea26c8ebf580af5c2b7e473dfc84d87.png)
### TLS 第二次握手
服务端收到客户端的「打招呼」，同样也要回礼，会返回「**Server Hello**」消息，消息面有服务器确认的 TLS 版本号，也给出了一个**随机数（_Server Random_）**，然后从客户端的密码套件列表选择了一个合适的密码套件。
![](https://raw.githubusercontent.com/danmuking/image/main/9e0e7cf89bbbd1b67da397526002bd57.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/1385328919e75f89d100350ce1c3727f.png)
这一步就和 RSA 握手过程有很大的区别了，因为服务端选择了 ECDHE 密钥协商算法，所以会在发送完证书后，发送「**Server Key Exchange**」消息。
![](https://raw.githubusercontent.com/danmuking/image/main/fea30e1caa125836fa717e4e7080d616.png)
这个过程服务器做了三件事：
...
![](https://raw.githubusercontent.com/danmuking/image/main/8a906fe1a6b9518e4067ea6260d7aeae.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/cdc4a6c3cbb87296fa27f7477bfdaec7.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/dfd690363a03ceae5f61dc3054fcfa94.png)
接着，客户端会发「**Encrypted Handshake Message**」消息，把之前发送的数据做一个摘要，再用对称密钥加密一下，让服务端做个验证，验证下本次生成的对称密钥是否可以正常使用。
![](https://raw.githubusercontent.com/danmuking/image/main/196c7db319ae36fdf65756df970672c0.png)
### TLS 第四次握手
