...
![](https://raw.githubusercontent.com/danmuking/image/main/634b17fe9ca77a5c6b90b850f441fab4.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/40dbb4775f84ebdf25ed1e893403196f.png)
如果需要保障网络数据包的可靠性，那么就需要由上层（传输层）的 TCP 协议来负责。
因为 TCP 是一个工作在**传输层**的**可靠**数据传输的服务，它能确保接收端接收的网络包是**无损坏、无间隔、非冗余和按序的。**
### 什么是 TCP ？
TCP 是**面向连接的、可靠的、基于字节流**的传输层通信协议。
![](https://raw.githubusercontent.com/danmuking/image/main/e42499063fab6db05acfc8f97dff0ada.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/f8d587d34627e4fdcec572ef390d219f.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/9363f5206bbb082cd55946645c2833c5.png)
源地址和目的地址的字段（32 位）是在 IP 头部中，作用是通过 IP 协议发送报文给对方主机。
源端口和目的端口的字段（16 位）是在 TCP 头部中，作用是告诉 TCP 协议应该把报文发给哪个进程。
有一个 IP 的服务端监听了一个端口，它的 TCP 的最大连接数是多少？
服务端通常固定在某个本地端口上监听，等待客户端的连接请求。
因此，客户端 IP 和端口是可变的，其理论值计算公式如下:
![](https://raw.githubusercontent.com/danmuking/image/main/0c2bbda492331c92ba493f3fc439bd78.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/4701eb9bfe3e9188c27267d214fda5c3.png)

- 目标和源端口：主要是告诉 UDP 协议应该把报文发给哪个进程。
- 包长度：该字段保存了 UDP 首部的长度跟数据的长度之和。
- 校验和：校验和是为了提供可靠的 UDP 首部和数据而设计，防止收到在网络传输中受损的 UDP 包。**TCP 和 UDP 区别：**
...
先说说 TCP 是如何计算负载数据长度：
![](https://raw.githubusercontent.com/danmuking/image/main/82ae40d6a6537e7eae60c031c5aa57de.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/b2c8f0c52dfdd22ec1ed293288dab494.jpeg)
...
![](https://raw.githubusercontent.com/danmuking/image/main/5abb364f2c3cdc7c7aa190bee2586618.png)

- 一开始，客户端和服务端都处于 CLOSE 状态。先是服务端主动监听某个端口，处于 LISTEN 状态

![](https://raw.githubusercontent.com/danmuking/image/main/74358e030940cea0fd222efd6265d5af.png)

- 客户端会随机初始化序号（client_isn），将此序号置于 TCP 首部的「序号」字段中，同时把 SYN 标志位置为 1，表示 SYN 报文。接着把第一个 SYN 报文发送给服务端，表示向服务端发起连接，该报文不包含应用层数据，之后客户端处于 SYN-SENT 状态。

![](https://raw.githubusercontent.com/danmuking/image/main/abed2fa7555531d2cf969eb93380443f.png)

- 服务端收到客户端的 SYN 报文后，首先服务端也随机初始化自己的序号（server_isn），将此序号填入 TCP 首部的「序号」字段中，其次把 TCP 首部的「确认应答号」字段填入 client_isn + 1, 接着把 SYN 和 ACK 标志位置为 1。最后把该报文发给客户端，该报文也不包含应用层数据，之后服务端处于 SYN-RCVD 状态。

![](https://raw.githubusercontent.com/danmuking/image/main/6c281cb3b823d44f22128b1b472f2143.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/93bc287555c1e1e6a06ad129e40435bb.png)
### 为什么是三次握手？不是两次、四次？
...
看看三次握手是如何阻止历史连接的：
![](https://raw.githubusercontent.com/danmuking/image/main/4f25f86685297e492bae6ea8b93f6068.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/98b477bcc2fa5de1856482bb3e8d9c16.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/eff82f06af96b32ad53a0fd17985da79.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/d3ee62de13ad236fd1da831ac9293dff.png)
四次握手其实也能够可靠的同步双方的初始化序号，但由于**第二步和第三步可以优化成一步**，所以就成了「三次握手」。
而两次握手只保证了一方的初始序列号能被对方成功接收，没办法保证双方的初始序列号都能被确认接收。
_原因三：避免资源浪费_
如果只有「两次握手」，当客户端发生的 SYN 报文在网络中阻塞，客户端没有接收到 ACK 报文，就会重新发送 SYN ，**由于没有第三次握手，服务端不清楚客户端是否收到了自己回复的 ACK 报文，所以服务端每收到一个 SYN 就只能先主动建立一个连接**，这会造成什么情况呢？
如果客户端发送的 SYN 报文在网络中阻塞了，重复发送多次 SYN 报文，那么服务端在收到请求后就会**建立多个冗余的无效链接，造成不必要的资源浪费。**
![](https://raw.githubusercontent.com/danmuking/image/main/6ae261711685d28eaedd720ed757b67c.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/c1ed9e3fa835341c08184adf1c5ee9c1.png)
过程如下：
...
![](https://raw.githubusercontent.com/danmuking/image/main/3fdd53418d026b030727e3df5534e17e.png)
...
我们先来认识下 MTU 和 MSS
![](https://raw.githubusercontent.com/danmuking/image/main/9a87003f7047e049a2dad4747c961c66.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/4957c3bd2d98617ea9e9c20040e84e57.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/30f599f37b51a8ee086d45c14b01581b.png)
具体过程：
...
![](https://raw.githubusercontent.com/danmuking/image/main/9ecb3bd6b092d46da7d625db3c853d73.png)
具体过程：
...
![](https://raw.githubusercontent.com/danmuking/image/main/98a441c79a422e1647a52c428a04d207.png)
具体过程：

- 当服务端超时重传 2 次 SYN-ACK 报文后，由于 tcp_synack_retries 为 2，已达到最大重传次数，于是再等待一段时间（时间为上一次超时时间的 2 倍），如果还是没能收到客户端的第三次握手（ACK 报文），那么服务端就会断开连接。
### 什么是 SYN 攻击？如何避免 SYN 攻击？
我们都知道 TCP 连接建立是需要三次握手，假设攻击者短时间伪造不同 IP 地址的 SYN 报文，服务端每接收到一个 SYN 报文，就进入SYN_RCVD 状态，但服务端发送出去的 ACK + SYN 报文，无法得到未知 IP 主机的 ACK 应答，久而久之就会**占满服务端的半连接队列**，使得服务端不能为正常用户服务。
![](https://raw.githubusercontent.com/danmuking/image/main/2080938ace4edd3611ae6bcf2b85e9e0.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/492591795ba243131ab70bc702136f02.png)
正常流程：
...
![](https://raw.githubusercontent.com/danmuking/image/main/a799d8eb8d28b454b9d90f82bb911d9e.png)
具体过程：
...
![](https://raw.githubusercontent.com/danmuking/image/main/003905a8b5a8bef309cd10c6308b2485.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/20f063256a9c2be16dc551a34a2353af.png)
具体过程：
...
![](https://raw.githubusercontent.com/danmuking/image/main/c7ae9135e50b0466b5af7ce6b0d7e077.png)
具体过程：
...
![](https://raw.githubusercontent.com/danmuking/image/main/8356e2af7ed6fc46845104eeea1e056b.png)
但是注意，如果主动关闭方使用 shutdown 函数关闭连接，指定了只关闭发送方向，而接收方向并没有关闭，那么意味着主动关闭方还是可以接收数据的。
此时，如果主动关闭方一直没收到第三次挥手，那么主动关闭方的连接将会一直处于 FIN_WAIT2 状态（tcp_fin_timeout 无法控制 shutdown 关闭的连接）。如下图：
![](https://raw.githubusercontent.com/danmuking/image/main/b9ad064adf1292fe64374c61ce248b3d.png)
### 第三次挥手丢失了，会发生什么？
...
![](https://raw.githubusercontent.com/danmuking/image/main/d04adf20375e51394a027da621ac6261.png)
具体过程：
...
![](https://raw.githubusercontent.com/danmuking/image/main/de0971142bbcf38d274a98bad93dc7f5.png)
具体过程：
...
![](https://raw.githubusercontent.com/danmuking/image/main/c5afc6adcc58e84bcb9c31ccc2b80a73.png)
通过前面我们知道，**序列号和初始化序列号并不是无限递增的，会发生回绕为初始值的情况，这意味着无法根据序列号来判断新老数据**。
假设 TIME-WAIT 没有等待时间或时间过短，被延迟的数据包抵达后会发生什么呢？
![](https://raw.githubusercontent.com/danmuking/image/main/7fb4206dbf82b4120a3dd911b172d4b1.png)
如上图：
...
![](https://raw.githubusercontent.com/danmuking/image/main/2102a5cd3bcc1ee5798141bbb1b4488d.png)
服务端收到这个 RST 并将其解释为一个错误（Connection reset by peer），这对于一个可靠的协议来说不是一个优雅的终止方式。
为了防止这种情况出现，客户端必须等待足够长的时间，确保服务端能够收到 ACK，如果服务端没有收到 ACK，那么就会触发 TCP 重传机制，服务端会重新发送一个 FIN，这样一去一来刚好两个 MSL 的时间。
![](https://raw.githubusercontent.com/danmuking/image/main/044c02ee0fff2e57d9f59635ce555d7f.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/76b08789c6193adbeac749b19b92848b.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/871fa27573cddfbc51aab4bf6125c91a.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/dd858490951a697e16dc5ec7bf183906.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/9a30d37f8aab6bacb8d47522a234e908.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/16083257a0e821e83bcd6f2a5e968240.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/26c7b9c2d0f1be24c29cbe643a0606c2.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/d1f0084ed86bc46e18f5eb2929df09a4.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/3d8f414781a879bb5f0380c2e05573e0.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/a3e3e17268659bca01945a9dc1fdbc2f.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/fcca61eeb1ddcd5c9b162d4611be6521.png)
