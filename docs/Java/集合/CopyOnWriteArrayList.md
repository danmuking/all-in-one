...
```
假设COW的变化如下图所示：
![20191215004616151.png](https://raw.githubusercontent.com/danmuking/image/main/5a0d878dce4134efc6de8438c167d157.png)
...
## 参考资料
[并发容器之CopyOnWriteArrayList详解_copyonwritearray 一致性-CSDN博客](https://blog.csdn.net/ThinkWon/article/details/102508258)
