...
这 7 个阶段的顺序如下图所示：
![](https://raw.githubusercontent.com/danmuking/image/main/bf90d8b36dba077894a08fe4c002afaa.png)
## 类加载过程
**Class 文件需要加载到虚拟机中之后才能运行和使用，那么虚拟机是如何加载这些 Class 文件呢？**
系统加载 Class 类型的文件主要三步：**加载->连接->初始化**。连接过程又可分为三步：**验证->准备->解析**。
![](https://raw.githubusercontent.com/danmuking/image/main/4a3ef678326387c1410cff8b43884862.png)
类加载过程
...
![](https://raw.githubusercontent.com/danmuking/image/main/85cb7315ba655fcae84a7df23db65e28.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/514f31e010fcf8475fe1040b6645972b.png)
基本数据类型的零值
### 解析
**解析阶段是虚拟机将常量池内的符号引用替换为直接引用的过程。** 解析动作主要针对类或接口、字段、类方法、接口方法、方法类型、方法句柄和调用限定符 7 类符号引用进行。
《深入理解 Java 虚拟机》7.34 节第三版对符号引用和直接引用的解释如下：
![](https://raw.githubusercontent.com/danmuking/image/main/aa2583dd93588c3da1e5031960623ead.png)
符号引用和直接引用
...
## 参考资料
[类加载过程详解](https://javaguide.cn/java/jvm/class-loading-process.html#%E5%88%9D%E5%A7%8B%E5%8C%96)
