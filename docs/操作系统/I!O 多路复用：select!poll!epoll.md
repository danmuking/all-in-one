...
好了，**发车！**
![](https://raw.githubusercontent.com/danmuking/image/main/bdcf2361dadec66ccbb5dcb6e49b9952.png)
## 最基本的 Socket 模型
...
![](https://raw.githubusercontent.com/danmuking/image/main/0e3d2c1e71a40fefd2246d621687b0e8.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/5e2452a0352e5c83f6b3ac051c233352.jpeg)
## 如何服务更多的用户？
...
![](https://raw.githubusercontent.com/danmuking/image/main/cdf301e887e92163c298841976ffa556.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/a84f70716ea7803d4c2e60757b62bd6c.png)
需要注意的是，这个队列是全局的，每个线程都会操作，为了避免多线程竞争，线程在操作这个队列前要加锁。
上面基于进程或者线程模型的，其实还是有问题的。新到来一个 TCP 连接，就需要分配一个进程或者线程，那么如果要达到 C10K，意味着要一台机器维护 1 万个连接，相当于要维护 1 万个进程/线程，操作系统就算死扛也是扛不住的。
## I/O 多路复用
既然为每个请求分配一个进程/线程的方式不合适，那有没有可能只使用一个进程来维护多个 Socket 呢？答案是有的，那就是 **I/O 多路复用**技术。
![](https://raw.githubusercontent.com/danmuking/image/main/0572a484bdcfc914decad5a250a6c98a.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/fad326cb6df9f4119ee2663fa46f38e2.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/f9c05d6d1012330641cb35cb964f79ea.png)
好了，这个题外话就说到这了，我们继续！
### 边缘触发和水平触发
...
## [#](https://xiaolincoding.com/os/8_network_system/selete_poll_epoll.html#%E5%85%B3%E6%B3%A8%E4%BD%9C%E8%80%85)关注作者
