...
![](https://raw.githubusercontent.com/danmuking/image/main/fcdd137e95c37e4a6dc8add10bfc3c28.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/1a8d34414948207ae0651b1c63912b43.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/d7ecf64f14a57a271144e60089e1a6aa.png)
对象结构里包含的成员变量：
...
![](https://raw.githubusercontent.com/danmuking/image/main/ccc389adbda806111849589bb3651937.png)
接下里，就好好聊一下底层数据结构！
## SDS
...
![](https://raw.githubusercontent.com/danmuking/image/main/7ebe5379abeeee7d87d94ded21fa74fa.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/2a6259aacf4550e3edda92dafbae2b1e.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/5f9f7eff6a3056a08c09af969247127c.png)
...
好了， 通过以上的分析，我们可以得知 **C 语言的字符串不足之处**以及可以改进的地方：
...
![](https://raw.githubusercontent.com/danmuking/image/main/0197da223f14ec011ddbefa829336591.png)
结构中的每个成员变量分别介绍下：
...
![](https://raw.githubusercontent.com/danmuking/image/main/b58f1607c61922343cdbde306be5f2a5.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/da847e2bdba792138f10d62b8a321b97.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/c73d3e4a77c3654747a8cee6428a4996.png)
### 链表结构设计
...
![](https://raw.githubusercontent.com/danmuking/image/main/999190ca2958d82b347c5f1cfb22ec18.png)
### 链表的优势与缺陷
Redis 的链表实现优点如下：
...
![](https://raw.githubusercontent.com/danmuking/image/main/ffdde7fff350d6104d85ce2be4dec700.png)
压缩列表在表头有三个字段：
...
![](https://raw.githubusercontent.com/danmuking/image/main/15539d42454aeec9823e0d4152e8a1b0.png)
压缩列表节点包含四部分内容：
...
![](https://raw.githubusercontent.com/danmuking/image/main/f9936cf57abd56c5c1501e3df87dc3e7.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/8bf325b9fd221bd9c6a07dc2d3492f70.png)
因为这些节点长度值小于 254 字节，所以 prevlen 属性需要用 1 字节的空间来保存这个长度值。
这时，如果将一个长度大于等于 254 字节的新节点加入到压缩列表的表头节点，即新节点将成为 e1 的前置节点，如下图：
![](https://raw.githubusercontent.com/danmuking/image/main/0ba74af72d84870208648f0135cc44df.png)
因为 e1 节点的 prevlen 属性只有 1 个字节大小，无法保存新节点的长度，此时就需要对压缩列表的空间重分配操作，并将 e1 节点的 prevlen 属性从原来的 1 字节大小扩展为 5 字节大小。
多米诺牌的效应就此开始。
![](https://raw.githubusercontent.com/danmuking/image/main/cbb971b47621635b7a3e08ebdba3d27b.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/d80afec57099a7fd68bad6750982093f.png)
哈希表节点的结构如下：
```c
...
![](https://raw.githubusercontent.com/danmuking/image/main/0133c6ed585cbed8e196f7282b7dd46f.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/b83817f6669c89c812cdeadbeeda255a.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/2d07ff06188a384f973504ea64777061.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/afa765a22b090668e301d54331f24535.png)
...
负载因子可以通过下面这个公式计算：
![](https://raw.githubusercontent.com/danmuking/image/main/27fe13c63f7e7761021371d80567702c.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/86fe03f8099368a24536d8a2ab4b9278.png)
现在，往这个整数集合中加入一个新元素 65535，这个新元素需要用 int32_t 类型来保存，所以整数集合要进行升级操作，首先需要为 contents 数组扩容，**在原本空间的大小之上再扩容多 80 位（4x32-3x16=80），这样就能保存下 4 个类型为 int32_t 的元素**。
![](https://raw.githubusercontent.com/danmuking/image/main/88222c2e158ea95ba5edb733a826cc94.png)
扩容完 contents 数组空间大小后，需要将之前的三个元素转换为 int32_t 类型，并将转换后的元素放置到正确的位上面，并且需要维持底层数组的有序性不变，整个转换过程如下：
![](https://raw.githubusercontent.com/danmuking/image/main/3178349e9a59c889d513892b4c168f70.png)
整数集合升级有什么好处呢？
...
![](https://raw.githubusercontent.com/danmuking/image/main/9f05d1c8494b7626f3b0ae83bd246945.png)
...
比如，下面这张图，展示了各个节点的跨度。
![](https://raw.githubusercontent.com/danmuking/image/main/e1b6f824d25527b63148ad9d0f217ea5.png)
...
举个例子，下图有个 3 层级的跳表。
![](https://raw.githubusercontent.com/danmuking/image/main/ca2b2092b9781891153af22e982d3c9c.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/9c22eb409b3f2af02ccdf6edea2e1f4e.png)
这时，如果想要查询节点 6，那基本就跟链表的查询复杂度一样，就需要在第一层的节点中依次顺序查找，复杂度就是 O(N) 了。所以，为了降低查询复杂度，我们就需要维持相邻层结点数间的关系。
**跳表的相邻两层的节点数量最理想的比例是 2:1，查找复杂度可以降低到 O(logN)**。
下图的跳表就是，相邻两层的节点数量的比例是 2 : 1。
![](https://raw.githubusercontent.com/danmuking/image/main/393f02e0a7940f860b473a14d25f017e.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/3949a9d964f8c27a754eaeda78d33a46.png)
...
我们先看看 listpack 结构：
![](https://raw.githubusercontent.com/danmuking/image/main/20387c5d9513a125c9b9e24ddcb7d5be.png)
listpack 头包含两个属性，分别记录了 listpack 总字节数和元素数量，然后 listpack 末尾也有个结尾标识。图中的 listpack entry 就是 listpack 的节点了。
每个 listpack 节点结构如下：
![](https://raw.githubusercontent.com/danmuking/image/main/34c749b059d35f86c9f550c81cbfa0de.png)
主要包含三个方面内容：
...
## 参考资料
[Redis 数据结构](https://xiaolincoding.com/redis/data_struct/data_struct.html#%E9%94%AE%E5%80%BC%E5%AF%B9%E6%95%B0%E6%8D%AE%E5%BA%93%E6%98%AF%E6%80%8E%E4%B9%88%E5%AE%9E%E7%8E%B0%E7%9A%84)
