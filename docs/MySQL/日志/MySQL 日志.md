...
![](https://raw.githubusercontent.com/danmuking/image/main/ca3846eb24f8c04b80c9159e046ceb4b.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/e87d4d129cdea99cef49dd204f98123e.png)
## 为什么需要 undo log？
...
![](https://raw.githubusercontent.com/danmuking/image/main/13b5f517e73ca4d0c80fcc3a4daa38a3.png)
...
版本链如下图：
![](https://raw.githubusercontent.com/danmuking/image/main/a6a217da173ab1f95274dc6e72495f87.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/4833129e2bcecd06470c6a204346a8fc.png)
有了 Buffer Poo 后：
...
![](https://raw.githubusercontent.com/danmuking/image/main/b20b3b0a7df50058b84c60e5e5e50ef9.png)
Undo 页是记录什么？
...
过程如下图：
![](https://raw.githubusercontent.com/danmuking/image/main/608f5b7e049493b54e5269a380bdcf3a.png)
什么是 redo log？
...
![](https://raw.githubusercontent.com/danmuking/image/main/071161d399fc197594f68862e195ce33.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/36b95d38de3e3a8e5598052f60b58d1e.webp)
...
我画了一个图，方便大家理解：
![](https://raw.githubusercontent.com/danmuking/image/main/e02be5713047b0172e22ad337dcba657.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/9ffbb837e113768bb0d4f8357caff279.png)
这三个参数的应用场景是什么？
...
![](https://raw.githubusercontent.com/danmuking/image/main/6fbeb7cf1d3e70f120a8c3d04b5b1662.png)
在重做日志组中，每个 redo log File 的大小是固定且一致的，假设每个 redo log File 设置的上限是 1 GB，那么总共就可以记录 2GB 的操作。
重做日志文件组是以**循环写**的方式工作的，从头开始写，写到末尾就又回到开头，相当于一个环形。
所以 InnoDB 存储引擎会先写 ib_logfile0 文件，当 ib_logfile0 文件被写满的时候，会切换至 ib_logfile1 文件，当 ib_logfile1 文件也被写满时，会切换回 ib_logfile0 文件。
![](https://raw.githubusercontent.com/danmuking/image/main/c4e667de861a04762ddbe26315bd66a7.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/c814527a39d6e5ee1c8ee46f8463ea4d.png)
图中的：
...
所以，一次 checkpoint 的过程就是脏页刷新到磁盘中变成干净页，然后标记 redo log 哪些记录可以被覆盖的过程。0
## 为什么需要 binlog ？
...
![](https://raw.githubusercontent.com/danmuking/image/main/792f9dd698abece31fe68332364cfb5f.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/8a784695c400cd8e3a28da8d54cc8a54.png)
从库是不是越多越好？
不是的。
...
![](https://raw.githubusercontent.com/danmuking/image/main/371966540f7ef03d48836f319a300916.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/544bd05f6c008b98ce8bc8ff424d8cc2.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/6fca43f5c3b7516d5150ad7a776971d2.png)
...
![image.png](https://raw.githubusercontent.com/danmuking/image/main/135d6410333ab193bd7b13fc42969913.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/ff85d49a52f03d0f4999822ee92aa40e.png)
接着，获取队列中的事务组，由绿色事务组的 Leader 对 redo log 做一次 write + fsync，即一次将同组事务的 redolog 刷盘：
![](https://raw.githubusercontent.com/danmuking/image/main/f4b0a0c572508a97e047e1d42682f77b.png)
完成了 prepare 阶段后，将绿色这一组事务执行过程中产生的 binlog 写入 binlog 文件（调用 write，不会调用 fsync，所以不会刷盘，binlog 缓存在操作系统的文件系统中）。
![](https://raw.githubusercontent.com/danmuking/image/main/33c34116e2981cb71b934523aa8a943f.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/e3322ff796075b8373ad7a3bc83c5eda.png)
不过，在等待的过程中，如果事务的数量提前达到了 Binlog_group_commit_sync_no_delay_count 参数设置的值，就不用继续等待了，就马上将 binlog 刷盘，如下图：
![](https://raw.githubusercontent.com/danmuking/image/main/ab8309dddb10dcd8d685d5a8e3128d16.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/f4aaa1d8544df083a06ff4e281ddb5e7.png)
...
## 参考资料
[MySQL 日志：undo log、redo log、binlog 有什么用？](https://xiaolincoding.com/mysql/log/how_update.html#mysql-%E7%A3%81%E7%9B%98-i-o-%E5%BE%88%E9%AB%98-%E6%9C%89%E4%BB%80%E4%B9%88%E4%BC%98%E5%8C%96%E7%9A%84%E6%96%B9%E6%B3%95)
