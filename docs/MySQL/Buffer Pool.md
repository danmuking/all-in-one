...
![](https://raw.githubusercontent.com/danmuking/image/main/e72bc780fbe8941cbec1d8678ac5ea88.png)
有了缓冲池后：
...
![](https://raw.githubusercontent.com/danmuking/image/main/e3b284bd7780a1b6bdad55f20a12408c.png)
为了更好的管理这些在 Buffer Pool 中的缓存页，InnoDB 为每一个缓存页都创建了一个**控制块**，控制块信息包括「缓存页的表空间、页号、缓存页地址、链表节点」等等。
控制块也是占有内存空间的，它是放在 Buffer Pool 的最前面，接着才是缓存页，如下图：
![](https://raw.githubusercontent.com/danmuking/image/main/e01d5f97f392b9f495cecd21e9fb2485.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/7ec3fc7e87233bcfab6aec8f0bf574f7.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/3f7c119da5957317616f5d89a6cc25bf.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/7b53955960280938dc3bc0845486a1e9.png)
如果访问了 3 号的页，因为 3 号页在 Buffer Pool 里，所以把 3 号页移动到头部即可。
![](https://raw.githubusercontent.com/danmuking/image/main/c8ef90566c4b9f177552e2b658cb2e0a.png)
而如果接下来，访问了 8 号页，因为 8 号页不在 Buffer Pool 里，所以需要先淘汰末尾的 5 号页，然后再将 8 号页加入到头部。
![](https://raw.githubusercontent.com/danmuking/image/main/77cf582b41b5713fea9d2382b871be6d.png)
到这里我们可以知道，Buffer Pool 里有三种页和链表来管理数据。
![](https://raw.githubusercontent.com/danmuking/image/main/4fddabf1e5cbd1513050815af1ccaf42.png)
图中：
...
![](https://raw.githubusercontent.com/danmuking/image/main/73e603a38447d32c87882ce4b1de8de2.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/b8d306e72eaa5e1dc9fd961f4e844993.png)
现在有个编号为 20 的页被预读了，这个页只会被插入到 old 区域头部，而 old 区域末尾的页（10号）会被淘汰掉。
![](https://raw.githubusercontent.com/danmuking/image/main/520dc85f88085d09fdd40b86f6222102.png)
如果 20 号页一直不会被访问，它也没有占用到 young 区域的位置，而且还会比 young 区域的数据更早被淘汰出去。
如果 20 号页被预读后，立刻被访问了，那么就会将它插入到 young 区域的头部，young 区域末尾的页（7号），会被挤到 old 区域，作为 old 区域的头部，这个过程并不会有页被淘汰。
![](https://raw.githubusercontent.com/danmuking/image/main/0316c22a3e1989fc97dca6af1fa91594.png)
...
![](https://raw.githubusercontent.com/danmuking/image/main/54b196d34c8c209d4115cb13e92f13ba.png)
在批量访问这些数据的时候，会被逐一插入到 young 区域头部。
![](https://raw.githubusercontent.com/danmuking/image/main/5779bee077fed93ad888771cb4481776.png)
...
## 参考资料
[揭开 Buffer Pool 的面纱](https://xiaolincoding.com/mysql/buffer_pool/buffer_pool.html#%E8%84%8F%E9%A1%B5%E4%BB%80%E4%B9%88%E6%97%B6%E5%80%99%E4%BC%9A%E8%A2%AB%E5%88%B7%E5%85%A5%E7%A3%81%E7%9B%98)
